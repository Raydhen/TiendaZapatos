    ...
    return (
        <>
        {
            <div className="detalles">
                ...
                {
                    url ? <img src={images} alt={detalle.title}></img> : <img src={detalle.image.default} alt={detalle.title}></img>
                }
                
                <input type="range" min="1" max="36" value={url} onChange={handleInput}></input>
                <div className="description"> 
                    <p><b>descripcion:</b> LOREM IPSUN DOLOR SIT. <br/> lorem ipsun dolor sit</p>
                </div>
